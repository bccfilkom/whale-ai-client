"use client";
import { TimeSeriesWithSMA } from "@/types/chart";
...
const TimeSeriesChartWithSMA = ({
  data,
  title = "",
  price = "",
}: {
  data: TimeSeriesWithSMA[];
  title: string;
  price: string;
}) => {
  const chartData = {
...
export default TimeSeriesChartWithSMA;
