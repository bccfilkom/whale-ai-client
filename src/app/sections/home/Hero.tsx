      ...
      <section className="hidden md:block container relative mb-20 w-full ">
        <div className="gap-2 lg:gap-5 flex flex-col absolute md:w-[100vw] lg:w-[40vw] ">
          ...
          <p className="text-white text-xs lg:text-base md:w-[30vw] lg:w-[35vw] xl:w-[30vw]">
            We simplify stock trading with tailored insights and tools, making
            it easy for anyone to grow their portfolio confidently.
          </p>
        </div>
...
"
      ...
      <section className="container py-[20vh] ">
        <div className="md:hidden flex flex-col gap-10 justify-center text-center">
